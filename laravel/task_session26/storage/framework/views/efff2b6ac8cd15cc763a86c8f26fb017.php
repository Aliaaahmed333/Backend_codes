...
<div class="single-post">
    <div class="post-header mb-5 text-center">
        ...
        <div class="post-featured-image mt-5">
            ...
            <img src="<?php echo e(asset('images/fashion/bg-banner.jpg')); ?>" class="img-fluid w-100" alt="featured-image">
        </div>
    </div>
    <div class="post-body">
          ...
          <p> The Sagoths had begun to take notice of his habit of declaiming throughout entire marches. One of them asked him what he was saying—to whom he was talking. The question gave me an idea, so I answered quickly before Perry could say anything.</p>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    ...
                    <img src="<?php echo e(asset('images/fashion/single-img1.png')); ?>"alt="post-ads" class="img-fluid mr-4 w-100">
                </div>
                <div class="col-lg-6 col-md-6">
                    <img src="<?php echo e(asset('images/fashion/single-img2.png')); ?>" alt="post-ads" class="img-fluid mr-4 w-100">
                </div>
            </div>
...
<?php /**PATH D:\Web_roadmap\Diploma\laravel\task_session26\resources\views/components/single-blog-content-component.blade.php ENDPATH**/ ?>