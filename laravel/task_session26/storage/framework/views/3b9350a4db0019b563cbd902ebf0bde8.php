...
<div class="row justify-content-center">
    <div class="col-lg-8">
        ...
        <form  method="POST" action="<?php echo e(route('create_contact')); ?>"id="contact-form" class="contact-form">
            <div class="row">
                <div class="col-md-12">
...
<?php echo $__env->make('layouts.app_layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Web_roadmap\Diploma\laravel\task_session26\resources\views/contact.blade.php ENDPATH**/ ?>