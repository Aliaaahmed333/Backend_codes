...
<div class="slider-item">
    <div class="slider-item-content">
        ...
        <div class="slider-post-content">
            <span class="cat-name">{{ $slider['category'] }}</span>

            <h3 class="post-title mt-1">
                <a href="#">{{ $slider['title'] }}</a>
            </h3>

            <span class="text-muted">{{ $slider['date'] }}</span>
        </div>
...
<div class="col-lg-3 col-md-6">
    <article class="post-grid mb-5">
        ...
        <a class="post-thumb mb-4 d-block" href="#">
            <img src="{{ asset($post['image']) }}" class="img-fluid w-100">
        </a>

        <span class="cat-name">{{ $post['category'] }}</span>
